...
void addNode() {
    ...
    else
    {
        ...
        if(current != NULL)
        {
            current->prev = newNode; // step 6: Mke the previous field of the current node point to the new nod
        }
...
void deleteNode()
{
    ...
    cout << "\nEnter teh roll number of the student whose record is to be deleted: ";
...
{ // Node to be deleted is not the first node
    ...
    { // if there's successor, update its pointer
